...
class Surface(Options):
    ...
    ior : float, optional
        Index of Refraction.
    opacity_texture : ezsim.textures.Texture | None, optional
        Opacity texture of the surface.
    roughness_texture : ezsim.textures.Texture | None, optional
        Roughness texture of the surface.
    metallic_texture : ezsim.textures.Texture | None, optional
        Metallic texture of the surface.
    normal_texture : ezsim.textures.Texture | None, optional
        Normal texture of the surface.
    emissive_texture : ezsim.textures.Texture | None, optional
        ...
        if isinstance(texture, ColorTexture):
            ...
            if isinstance(opacity_texture, ColorTexture):
                ...
                if isinstance(opacity_texture, ImageTexture) and opacity_texture.image_array is not None:
                    ezsim.logger.warning("Color and opacity image shapes do not match. Fall back to fully opaque texture.")
...
class Glass(Surface):
    ...
    emissive : tuple | None, optional
        Emissive color of the surface. Shortcut for `emissive_texture` with a single color.
    specular_texture : ezsim.textures.Texture | None, optional
        Specular texture of the surface.
    transmission_texture : ezsim.textures.Texture | None, optional
    ...
    emissive_texture : ezsim.textures.Texture | None, optional
        Emissive texture of the surface.
    thickness_texture : ezsim.textures.Texture | None, optional
    ...
    def __init__(self, **data):
        ...
        if self.thickness is not None:
            if self.thickness_texture is not None:
                ezsim.raise_exception(self.shortcut_info("thickness", "thickness_texture"))
...
class Metal(Surface):
    ...
    diffuse_texture : ezsim.textures.Texture | None, optional
    ...
    def __init__(self, **data):
        ...
        if self.metal_type not in ["aluminium", "gold", "copper", "brass", "iron", "titanium", "vanadium", "lithium"]:
            ezsim.raise_exception(f"Invalid metal metal_type: {self.metal_type}.")
...
class BSDF(Surface):
    ...
    diffuse_texture : ezsim.textures.Texture | None, optional
        Diffuse (basic color) texture of the surface.
    specular_tint : ezsim.textures.Texture | None, optional
        Specular texture of the surface.
    opacity_texture : ezsim.textures.Texture | None, optional
        Opacity texture of the surface.
    roughness_texture : ezsim.textures.Texture | None, optional
