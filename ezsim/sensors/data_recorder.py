...
import ezsim
from ezsim.options.recording import RecordingOptions
...
class SensorDataRecorder:
    ...
    def pause_recording(self):
        ...
        if not self._is_recording:
            ezsim.logger.warning("Ignoring pause_recording(): data recording is not active.")
            return
    ...
    def stop_recording(self):
        ...
        if not self._is_recording:
            ezsim.logger.warning("Ignoring stop_recording(): data recording is not active.")
            return
        self._is_recording = False
    ...
    def read_sensor(self, rec_idx=0):
        ...
        try:
            ...
            ezsim.logger.warning("Data queue is full, dropping oldest data sample.")
