...
import ezsim
from ezsim.options import Options
...
class Sensor(RBC):
    ...
    def _update_shared_cache(
        ...
        NOTE: 
        =========
        The implementation should include applying the delay using the `_apply_delay_to_shared_cache()` method.
        """
    ...
    def _apply_delay_to_shared_cache(
        cls, shared_metadata: SharedSensorMetadata, shared_cache: torch.Tensor, buffered_data: "TensorRingBuffer"
    ):
        """
