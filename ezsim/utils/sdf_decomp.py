...
def sdf_func_world(
    ...
    if geoms_info.type[geom_idx] == ezsim.GEOM_TYPE.SPHERE:
        sd = (pos_world - g_pos).norm() - geoms_info.data[geom_idx][0]

    elif geoms_info.type[geom_idx] == ezsim.GEOM_TYPE.PLANE:
...
def sdf_func_true_grad(
    ...
    if geoms_info.type[geom_idx] == ezsim.GEOM_TYPE.TERRAIN:  # Terrain uses finite difference
