...
use_ndarray = os.environ.get("EZSIM_USE_NDARRAY", "0") == "1"
...
def get_rigid_global_info(solver):
    ...
    # Basic fields
    kwargs = {
        "n_awake_dofs": V(dtype=ezsim.ti_int, shape=f_batch()),
        "awake_dofs": V(dtype=ezsim.ti_int, shape=f_batch(solver.n_dofs_)),
        "n_awake_entities": V(dtype=ezsim.ti_int, shape=f_batch()),
        "awake_entities": V(dtype=ezsim.ti_int, shape=f_batch(solver.n_entities_)),
        "n_awake_links": V(dtype=ezsim.ti_int, shape=f_batch()),
        "awake_links": V(dtype=ezsim.ti_int, shape=f_batch(solver.n_links)),
        "qpos0": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_qs_)),
        "qpos": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_qs_)),
        "links_T": V_MAT(n=4, m=4, dtype=ezsim.ti_float, shape=solver.n_links),
        "envs_offset": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch()),
        "geoms_init_AABB": V_VEC(3, dtype=ezsim.ti_float, shape=(solver.n_geoms_, 8)),
        "mass_mat": V(dtype=ezsim.ti_float, shape=solver._batch_shape((solver.n_dofs_, solver.n_dofs_))),
        "mass_mat_L": V(dtype=ezsim.ti_float, shape=solver._batch_shape((solver.n_dofs_, solver.n_dofs_))),
        "mass_mat_D_inv": V(dtype=ezsim.ti_float, shape=solver._batch_shape((solver.n_dofs_,))),
        "_mass_mat_mask": V(dtype=ezsim.ti_int, shape=solver._batch_shape(solver.n_entities_)),
        "meaninertia": V(dtype=ezsim.ti_float, shape=solver._batch_shape()),
        "mass_parent_mask": V(dtype=ezsim.ti_float, shape=(solver.n_dofs_, solver.n_dofs_)),
        "gravity": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch()),
    }
...
def _init_mass_mat_data(obj, solver):
    ...
    mass_parent_mask = np.zeros((solver.n_dofs_, solver.n_dofs_), dtype=ezsim.np_float)
...
def get_constraint_state(constraint_solver, solver):
    ...
    kwargs = {
        "n_constraints": V(dtype=ezsim.ti_int, shape=f_batch()),
        "ti_n_equalities": V(ezsim.ti_int, shape=solver._batch_shape()),
        "jac": V(dtype=ezsim.ti_float, shape=solver._batch_shape((len_constraints_, solver.n_dofs_))),
        "diag": V(dtype=ezsim.ti_float, shape=solver._batch_shape(len_constraints_)),
        "aref": V(dtype=ezsim.ti_float, shape=solver._batch_shape(len_constraints_)),
        "jac_relevant_dofs": V(ezsim.ti_int, shape=solver._batch_shape((len_constraints_, solver.n_dofs_))),
        "jac_n_relevant_dofs": V(ezsim.ti_int, shape=solver._batch_shape(len_constraints_)),
        "n_constraints_equality": V(ezsim.ti_int, shape=solver._batch_shape()),
        "n_constraints_frictionloss": V(ezsim.ti_int, shape=solver._batch_shape()),
        "improved": V(ezsim.ti_int, shape=solver._batch_shape()),
        "Jaref": V(dtype=ezsim.ti_float, shape=solver._batch_shape(len_constraints_)),
        "Ma": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "Ma_ws": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "grad": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "Mgrad": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "search": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        ...
        "qacc_ws": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "qacc_prev": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "cost_ws": V(ezsim.ti_float, shape=solver._batch_shape()),
        "gauss": V(ezsim.ti_float, shape=solver._batch_shape()),
        "cost": V(ezsim.ti_float, shape=solver._batch_shape()),
        "prev_cost": V(ezsim.ti_float, shape=solver._batch_shape()),
        "gtol": V(ezsim.ti_float, shape=solver._batch_shape()),
        "mv": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "jv": V(dtype=ezsim.ti_float, shape=solver._batch_shape(len_constraints_)),
        "quad_gauss": V(dtype=ezsim.ti_float, shape=solver._batch_shape(3)),
        "quad": V(dtype=ezsim.ti_float, shape=solver._batch_shape((len_constraints_, 3))),
        "candidates": V(dtype=ezsim.ti_float, shape=solver._batch_shape(12)),
        "ls_its": V(ezsim.ti_float, shape=solver._batch_shape()),
        "ls_result": V(ezsim.ti_int, shape=solver._batch_shape()),
        "cg_prev_grad": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "cg_prev_Mgrad": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
        "cg_beta": V(ezsim.ti_float, shape=solver._batch_shape()),
        "cg_pg_dot_pMg": V(ezsim.ti_float, shape=solver._batch_shape()),
        "nt_H": V(dtype=ezsim.ti_float, shape=solver._batch_shape((solver.n_dofs_, solver.n_dofs_))),
        "nt_vec": V(dtype=ezsim.ti_float, shape=solver._batch_shape(solver.n_dofs_)),
    }

    # Add solver-specific fields
    # if constraint_solver._solver_type == ezsim.constraint_solver.CG:
    #     kwargs.update(
    #         {
    #         }
    #     )

    # if constraint_solver._solver_type == ezsim.constraint_solver.Newton:
    #     kwargs.update(
    #         {
    #         }
    #     )
    ...
    if use_ndarray:
        ...
        obj.ti_n_equalities.from_numpy(np.full((solver._B,), solver.n_equalities, dtype=ezsim.np_int))
        return obj
    else:
        ...
        class ClassConstraintState:
            def __init__(self):
                for k, v in kwargs.items():
                    setattr(self, k, v)
                self.ti_n_equalities.from_numpy(np.full((solver._B,), solver.n_equalities, dtype=ezsim.np_int))
...
def get_contact_data(solver, max_contact_pairs):
    ...
    kwargs = {
        "geom_a": V(dtype=ezsim.ti_int, shape=f_batch(max_contact_pairs_)),
        "geom_b": V(dtype=ezsim.ti_int, shape=f_batch(max_contact_pairs_)),
        "penetration": V(dtype=ezsim.ti_float, shape=f_batch(max_contact_pairs_)),
        "normal": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(max_contact_pairs_)),
        "pos": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(max_contact_pairs_)),
        "friction": V(dtype=ezsim.ti_float, shape=f_batch(max_contact_pairs_)),
        "sol_params": V_VEC(7, dtype=ezsim.ti_float, shape=f_batch(max_contact_pairs_)),
        "force": V(dtype=ezsim.ti_vec3, shape=f_batch(max_contact_pairs_)),
        "link_a": V(dtype=ezsim.ti_int, shape=f_batch(max_contact_pairs_)),
        "link_b": V(dtype=ezsim.ti_int, shape=f_batch(max_contact_pairs_)),
    }
...
def get_sort_buffer(solver):
    f_batch = solver._batch_shape
    kwargs = {
        "value": V(dtype=ezsim.ti_float, shape=f_batch(2 * solver.n_geoms_)),
        "i_g": V(dtype=ezsim.ti_int, shape=f_batch(2 * solver.n_geoms_)),
        "is_max": V(dtype=ezsim.ti_int, shape=f_batch(2 * solver.n_geoms_)),
    }
    if use_ndarray:
...
def get_contact_cache(solver):
    ...
    kwargs = {
        "normal": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch((n_geoms, n_geoms))),
    }
    if use_ndarray:
...
def get_collider_state(solver, n_possible_pairs, collider_static_config):
    ...
    kwargs = {
        ...
        "active_buffer": V(dtype=ezsim.ti_int, shape=f_batch(n_geoms)),
        "n_broad_pairs": V(dtype=ezsim.ti_int, shape=_B),
        "broad_collision_pairs": V_VEC(2, dtype=ezsim.ti_int, shape=f_batch(max(1, max_collision_pairs_broad))),
        "active_buffer_awake": V(dtype=ezsim.ti_int, shape=f_batch(n_geoms)),
        "active_buffer_hib": V(dtype=ezsim.ti_int, shape=f_batch(n_geoms)),
        "box_depth": V(dtype=ezsim.ti_float, shape=f_batch(collider_static_config.box_MAXCONPAIR)),
        "box_points": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(collider_static_config.box_MAXCONPAIR)),
        "box_pts": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(6)),
        "box_lines": V_VEC(6, dtype=ezsim.ti_float, shape=f_batch(4)),
        "box_linesu": V_VEC(6, dtype=ezsim.ti_float, shape=f_batch(4)),
        "box_axi": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(3)),
        "box_ppts2": V(dtype=ezsim.ti_float, shape=f_batch((4, 2))),
        "box_pu": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(4)),
        "xyz_max_min": V(dtype=ezsim.ti_float, shape=f_batch(6)),
        "prism": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(6)),
        "n_contacts": V(dtype=ezsim.ti_int, shape=_B),
        "n_contacts_hibernated": V(dtype=ezsim.ti_int, shape=_B),
        "first_time": V(dtype=ezsim.ti_int, shape=_B),
...
def get_collider_info(solver, n_vert_neighbors, collider_static_config):
    ...
    if collider_static_config.has_terrain:
        links_idx = solver.geoms_info.link_idx.to_numpy()[solver.geoms_info.type.to_numpy() == ezsim.GEOM_TYPE.TERRAIN]
        entity = solver._entities[solver.links_info.entity_idx.to_numpy()[links_idx[0]]]
        terrain_hf_shape = entity.terrain_hf.shape

    kwargs = {
        "vert_neighbors": V(dtype=ezsim.ti_int, shape=max(1, n_vert_neighbors)),
        "vert_neighbor_start": V(dtype=ezsim.ti_int, shape=n_verts),
        "vert_n_neighbors": V(dtype=ezsim.ti_int, shape=n_verts),
        "collision_pair_validity": V(dtype=ezsim.ti_int, shape=(n_geoms, n_geoms)),
        "_max_possible_pairs": V(dtype=ezsim.ti_int, shape=()),
        "_max_collision_pairs": V(dtype=ezsim.ti_int, shape=()),
        "_max_contact_pairs": V(dtype=ezsim.ti_int, shape=()),
        "_max_collision_pairs_broad": V(dtype=ezsim.ti_int, shape=()),
        "terrain_hf": V(dtype=ezsim.ti_float, shape=terrain_hf_shape),
        "terrain_rc": V(dtype=ezsim.ti_int, shape=2),
        "terrain_scale": V(dtype=ezsim.ti_float, shape=2),
        "terrain_xyz_maxmin": V(dtype=ezsim.ti_float, shape=6),
    }
...
def get_mpr_simplex_support(f_batch):
    kwargs = {
        "v1": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(4)),
        "v2": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(4)),
        "v": V_VEC(3, dtype=ezsim.ti_float, shape=f_batch(4)),
    }
...
def get_mpr_state(f_batch):
    ...
    kwargs = {
        ...
        "simplex_size": V(dtype=ezsim.ti_int, shape=f_batch()),
    }
...
def get_gjk_simplex_vertex(solver):
    _B = solver._B
    kwargs = {
        "obj1": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, 4)),
        "obj2": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, 4)),
        "id1": V(dtype=ezsim.ti_int, shape=(_B, 4)),
        "id2": V(dtype=ezsim.ti_int, shape=(_B, 4)),
        "mink": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, 4)),
    }
...
def get_epa_polytope_vertex(solver, gjk_static_config):
    ...
    kwargs = {
        "obj1": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_num_polytope_verts)),
        "obj2": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_num_polytope_verts)),
        "id1": V(dtype=ezsim.ti_int, shape=(_B, max_num_polytope_verts)),
        "id2": V(dtype=ezsim.ti_int, shape=(_B, max_num_polytope_verts)),
        "mink": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_num_polytope_verts)),
    }
...
def get_gjk_simplex(solver):
    _B = solver._B
    kwargs = {
        "nverts": V(dtype=ezsim.ti_int, shape=(_B,)),
        "dist": V(dtype=ezsim.ti_float, shape=(_B,)),
    }
...
def get_gjk_simplex_buffer(solver):
    _B = solver._B
    kwargs = {
        "normal": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, 4)),
        "sdist": V(dtype=ezsim.ti_float, shape=(_B, 4)),
    }
...
def get_epa_polytope(solver):
    ...
    kwargs = {
        "nverts": V(dtype=ezsim.ti_int, shape=(_B,)),
        "nfaces": V(dtype=ezsim.ti_int, shape=(_B,)),
        "nfaces_map": V(dtype=ezsim.ti_int, shape=(_B,)),
        "horizon_nedges": V(dtype=ezsim.ti_int, shape=(_B,)),
        "horizon_w": V_VEC(3, dtype=ezsim.ti_float, shape=(_B,)),
    }
...
def get_epa_polytope_face(solver, polytope_max_faces):
    ...
    kwargs = {
        "verts_idx": V_VEC(3, dtype=ezsim.ti_int, shape=(_B, polytope_max_faces)),
        "adj_idx": V_VEC(3, dtype=ezsim.ti_int, shape=(_B, polytope_max_faces)),
        "normal": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, polytope_max_faces)),
        "dist2": V(dtype=ezsim.ti_float, shape=(_B, polytope_max_faces)),
        "map_idx": V(dtype=ezsim.ti_int, shape=(_B, polytope_max_faces)),
    }
...
def get_epa_polytope_horizon_data(solver, polytope_max_horizons):
    _B = solver._B
    kwargs = {
        "face_idx": V(dtype=ezsim.ti_int, shape=(_B, polytope_max_horizons)),
        "edge_idx": V(dtype=ezsim.ti_int, shape=(_B, polytope_max_horizons)),
    }
...
def get_contact_face(solver, max_contact_polygon_verts):
    _B = solver._B
    kwargs = {
        "vert1": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "vert2": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "endverts": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "normal1": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "normal2": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "id1": V(dtype=ezsim.ti_int, shape=(_B, max_contact_polygon_verts)),
        "id2": V(dtype=ezsim.ti_int, shape=(_B, max_contact_polygon_verts)),
    }
...
def get_contact_normal(solver, max_contact_polygon_verts):
    ...
    kwargs = {
        "endverts": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "normal": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "id": V(dtype=ezsim.ti_int, shape=(_B, max_contact_polygon_verts)),
    }
    if use_ndarray:
...
def get_contact_halfspace(solver, max_contact_polygon_verts):
    ...
    kwargs = {
        "normal": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
        "dist": V(dtype=ezsim.ti_float, shape=(_B, max_contact_polygon_verts)),
    }
    if use_ndarray:
...
def get_witness(solver, max_contacts_per_pair):
    _B = solver._B
    kwargs = {
        "point_obj1": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contacts_per_pair)),
        "point_obj2": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contacts_per_pair)),
    }
...
def get_gjk_state(solver, static_rigid_sim_config, gjk_static_config):
    ...
    nsimplex = V(dtype=ezsim.ti_int, shape=(_B,))  # if enable_mujoco_compatibility else None

    kwargs = {
        "support_mesh_prev_vertex_id": V(dtype=ezsim.ti_int, shape=(_B, 2)),
        "simplex_vertex": simplex_vertex,
        "simplex_buffer": simplex_buffer,
        "simplex": simplex,
        "last_searched_simplex_vertex_id": V(dtype=ezsim.ti_int, shape=(_B,)),
    ...
    kwargs.update(
        {
            ...
            "polytope_faces_map": V(dtype=ezsim.ti_int, shape=(_B, polytope_max_faces)),
    ...
    contact_clipped_polygons = V_VEC(
        3, dtype=ezsim.ti_float, shape=(_B, 2, max_contact_polygon_verts)
    )  # if enable_mujoco_compatibility else None
    kwargs.update(
        {
            ...
            "multi_contact_flag": V(dtype=ezsim.ti_int, shape=(_B,)),
        }
    )
    ...
    kwargs.update(
        {
            "witness": witness,
            "n_witness": V(dtype=ezsim.ti_int, shape=(_B,)),
            "n_contacts": V(dtype=ezsim.ti_int, shape=(_B,)),
            "contact_pos": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contacts_per_pair)),
            "normal": V_VEC(3, dtype=ezsim.ti_float, shape=(_B, max_contacts_per_pair)),
            "is_col": V(dtype=ezsim.ti_int, shape=(_B,)),
            "penetration": V(dtype=ezsim.ti_float, shape=(_B,)),
            "distance": V(dtype=ezsim.ti_float, shape=(_B,)),
        }
    )
...
def get_support_field_info(n_geoms, n_support_cells):
    kwargs = {
        "support_cell_start": V(dtype=ezsim.ti_int, shape=max(1, n_geoms)),
        "support_v": V_VEC(3, dtype=ezsim.ti_float, shape=max(1, n_support_cells)),
        "support_vid": V(dtype=ezsim.ti_int, shape=max(1, n_support_cells)),
    }
...
def get_sdf_geom_info(n_geoms):
    kwargs = {
        "T_mesh_to_sdf": V_MAT(n=4, m=4, dtype=ezsim.ti_float, shape=(max(1, n_geoms),)),
        "sdf_res": V_VEC(3, dtype=ezsim.ti_int, shape=(max(1, n_geoms),)),
        "sdf_max": V(dtype=ezsim.ti_float, shape=(max(1, n_geoms),)),
        "sdf_cell_size": V(dtype=ezsim.ti_float, shape=(max(1, n_geoms),)),
        "sdf_cell_start": V(dtype=ezsim.ti_int, shape=(max(1, n_geoms),)),
    }
...
def get_sdf_info(n_geoms, n_cells):
    kwargs = {
        ...
        "geoms_sdf_start": V(dtype=ezsim.ti_int, shape=(max(1, n_geoms),)),
        "geoms_sdf_val": V(dtype=ezsim.ti_float, shape=(max(1, n_cells),)),
        "geoms_sdf_grad": V_VEC(3, dtype=ezsim.ti_float, shape=(max(1, n_cells),)),
        "geoms_sdf_closest_vert": V(dtype=ezsim.ti_int, shape=(max(1, n_cells),)),
    }
...
def get_dofs_info(solver):
    ...
    kwargs = {
        "stiffness": V(dtype=ezsim.ti_float, shape=shape),
        "invweight": V(dtype=ezsim.ti_float, shape=shape),
        "armature": V(dtype=ezsim.ti_float, shape=shape),
        "damping": V(dtype=ezsim.ti_float, shape=shape),
        "frictionloss": V(dtype=ezsim.ti_float, shape=shape),
        "motion_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "motion_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "limit": V(dtype=ezsim.ti_vec2, shape=shape),
        "dof_start": V(dtype=ezsim.ti_int, shape=shape),
        "kp": V(dtype=ezsim.ti_float, shape=shape),
        "kv": V(dtype=ezsim.ti_float, shape=shape),
        "force_range": V(dtype=ezsim.ti_vec2, shape=shape),
    }
...
def get_dofs_state(solver):
    ...
    kwargs = {
        "force": V(dtype=ezsim.ti_float, shape=shape),
        "qf_bias": V(dtype=ezsim.ti_float, shape=shape),
        "qf_passive": V(dtype=ezsim.ti_float, shape=shape),
        "qf_actuator": V(dtype=ezsim.ti_float, shape=shape),
        "qf_applied": V(dtype=ezsim.ti_float, shape=shape),
        "act_length": V(dtype=ezsim.ti_float, shape=shape),
        "pos": V(dtype=ezsim.ti_float, shape=shape),
        "vel": V(dtype=ezsim.ti_float, shape=shape),
        "vel_prev": V(dtype=ezsim.ti_float, shape=shape),
        "acc": V(dtype=ezsim.ti_float, shape=shape),
        "acc_smooth": V(dtype=ezsim.ti_float, shape=shape),
        "qf_smooth": V(dtype=ezsim.ti_float, shape=shape),
        "qf_constraint": V(dtype=ezsim.ti_float, shape=shape),
        "cdof_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cdof_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "cdofvel_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cdofvel_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "cdofd_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cdofd_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "f_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "f_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "ctrl_force": V(dtype=ezsim.ti_float, shape=shape),
        "ctrl_pos": V(dtype=ezsim.ti_float, shape=shape),
        "ctrl_vel": V(dtype=ezsim.ti_float, shape=shape),
        "ctrl_mode": V(dtype=ezsim.ti_int, shape=shape),
        "hibernated": V(dtype=ezsim.ti_int, shape=shape),
    }
...
def get_links_state(solver):
    ...
    kwargs = {
        "cinr_inertial": V(dtype=ezsim.ti_mat3, shape=shape),
        "cinr_pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "cinr_quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "cinr_mass": V(dtype=ezsim.ti_float, shape=shape),
        "crb_inertial": V(dtype=ezsim.ti_mat3, shape=shape),
        "crb_pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "crb_quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "crb_mass": V(dtype=ezsim.ti_float, shape=shape),
        "cdd_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "cdd_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "i_pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "i_quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "j_pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "j_quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "j_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "j_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cd_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cd_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "mass_sum": V(dtype=ezsim.ti_float, shape=shape),
        "COM": V(dtype=ezsim.ti_vec3, shape=shape),
        "mass_shift": V(dtype=ezsim.ti_float, shape=shape),
        "i_pos_shift": V(dtype=ezsim.ti_vec3, shape=shape),
        "cacc_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cacc_lin": V(dtype=ezsim.ti_vec3, shape=shape),
        "cfrc_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cfrc_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "cfrc_applied_ang": V(dtype=ezsim.ti_vec3, shape=shape),
        "cfrc_applied_vel": V(dtype=ezsim.ti_vec3, shape=shape),
        "contact_force": V(dtype=ezsim.ti_vec3, shape=shape),
        "hibernated": V(dtype=ezsim.ti_int, shape=shape),
    }
...
def get_links_info(solver):
    ...
    kwargs = {
        "parent_idx": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "root_idx": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "q_start": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "dof_start": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "joint_start": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "q_end": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "dof_end": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "joint_end": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "n_dofs": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "pos": V(dtype=ezsim.ti_vec3, shape=links_info_shape),
        "quat": V(dtype=ezsim.ti_vec4, shape=links_info_shape),
        "invweight": V(dtype=ezsim.ti_vec2, shape=links_info_shape),
        "is_fixed": V(dtype=ezsim.ti_int, shape=links_info_shape),
        "inertial_pos": V(dtype=ezsim.ti_vec3, shape=links_info_shape),
        "inertial_quat": V(dtype=ezsim.ti_vec4, shape=links_info_shape),
        "inertial_i": V(dtype=ezsim.ti_mat3, shape=links_info_shape),
        "inertial_mass": V(dtype=ezsim.ti_float, shape=links_info_shape),
        "entity_idx": V(dtype=ezsim.ti_int, shape=links_info_shape),
    }
...
def get_joints_info(solver):
    ...
    kwargs = {
        "type": V(dtype=ezsim.ti_int, shape=shape),
        "sol_params": V(dtype=ezsim.ti_vec7, shape=shape),
        "q_start": V(dtype=ezsim.ti_int, shape=shape),
        "dof_start": V(dtype=ezsim.ti_int, shape=shape),
        "q_end": V(dtype=ezsim.ti_int, shape=shape),
        "dof_end": V(dtype=ezsim.ti_int, shape=shape),
        "n_dofs": V(dtype=ezsim.ti_int, shape=shape),
        "pos": V(dtype=ezsim.ti_vec3, shape=shape),
    }
...
def get_joints_state(solver):
    ...
    kwargs = {
        "xanchor": V(dtype=ezsim.ti_vec3, shape=shape),
        "xaxis": V(dtype=ezsim.ti_vec3, shape=shape),
    }
...
def get_geoms_info(solver):
    ...
    kwargs = {
        "pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "center": V(dtype=ezsim.ti_vec3, shape=shape),
        "quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "data": V(dtype=ezsim.ti_vec7, shape=shape),
        "link_idx": V(dtype=ezsim.ti_int, shape=shape),
        "type": V(dtype=ezsim.ti_int, shape=shape),
        "friction": V(dtype=ezsim.ti_float, shape=shape),
        "sol_params": V(dtype=ezsim.ti_vec7, shape=shape),
        "vert_num": V(dtype=ezsim.ti_int, shape=shape),
        "vert_start": V(dtype=ezsim.ti_int, shape=shape),
        "vert_end": V(dtype=ezsim.ti_int, shape=shape),
        "verts_state_start": V(dtype=ezsim.ti_int, shape=shape),
        "verts_state_end": V(dtype=ezsim.ti_int, shape=shape),
        "face_num": V(dtype=ezsim.ti_int, shape=shape),
        "face_start": V(dtype=ezsim.ti_int, shape=shape),
        "face_end": V(dtype=ezsim.ti_int, shape=shape),
        "edge_num": V(dtype=ezsim.ti_int, shape=shape),
        "edge_start": V(dtype=ezsim.ti_int, shape=shape),
        "edge_end": V(dtype=ezsim.ti_int, shape=shape),
        "is_convex": V(dtype=ezsim.ti_int, shape=shape),
        "contype": V(dtype=ezsim.ti_int, shape=shape),
        "conaffinity": V(dtype=ezsim.ti_int, shape=shape),
        "is_free": V(dtype=ezsim.ti_int, shape=shape),
        "is_decomposed": V(dtype=ezsim.ti_int, shape=shape),
        "needs_coup": V(dtype=ezsim.ti_int, shape=shape),
        "coup_friction": V(dtype=ezsim.ti_float, shape=shape),
        "coup_softness": V(dtype=ezsim.ti_float, shape=shape),
        "coup_restitution": V(dtype=ezsim.ti_float, shape=shape),
    }
...
def get_geoms_state(solver):
    ...
    kwargs = {
        "pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "aabb_min": V(dtype=ezsim.ti_vec3, shape=shape),
        "aabb_max": V(dtype=ezsim.ti_vec3, shape=shape),
        "verts_updated": V(dtype=ezsim.ti_int, shape=shape),
        "min_buffer_idx": V(dtype=ezsim.ti_int, shape=shape),
        "max_buffer_idx": V(dtype=ezsim.ti_int, shape=shape),
        "hibernated": V(dtype=ezsim.ti_int, shape=shape),
        "friction_ratio": V(dtype=ezsim.ti_float, shape=shape),
    }
...
def get_verts_info(solver):
    ...
    kwargs = {
        "init_pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "init_normal": V(dtype=ezsim.ti_vec3, shape=shape),
        "geom_idx": V(dtype=ezsim.ti_int, shape=shape),
        "init_center_pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "verts_state_idx": V(dtype=ezsim.ti_int, shape=shape),
        "is_free": V(dtype=ezsim.ti_int, shape=shape),
    }
...
def get_faces_info(solver):
    ...
    kwargs = {
        "verts_idx": V(dtype=ezsim.ti_ivec3, shape=shape),
        "geom_idx": V(dtype=ezsim.ti_int, shape=shape),
    }
...
def get_edges_info(solver):
    ...
    kwargs = {
        "v0": V(dtype=ezsim.ti_int, shape=shape),
        "v1": V(dtype=ezsim.ti_int, shape=shape),
        "length": V(dtype=ezsim.ti_float, shape=shape),
    }
...
def get_vverts_info(solver):
    ...
    kwargs = {
        "init_pos": V(dtype=ezsim.ti_vec3, shape=shape),
        "init_vnormal": V(dtype=ezsim.ti_vec3, shape=shape),
        "vgeom_idx": V(dtype=ezsim.ti_int, shape=shape),
    }
...
def get_vfaces_info(solver):
    ...
    kwargs = {
        "vverts_idx": V(dtype=ezsim.ti_ivec3, shape=shape),
        "vgeom_idx": V(dtype=ezsim.ti_int, shape=shape),
    }
...
def get_vgeoms_info(solver):
    ...
    kwargs = {
        ...
        "quat": V(dtype=ezsim.ti_vec4, shape=shape),
        "link_idx": V(dtype=ezsim.ti_int, shape=shape),
        "vvert_num": V(dtype=ezsim.ti_int, shape=shape),
        "vvert_start": V(dtype=ezsim.ti_int, shape=shape),
        "vvert_end": V(dtype=ezsim.ti_int, shape=shape),
        "vface_num": V(dtype=ezsim.ti_int, shape=shape),
        "vface_start": V(dtype=ezsim.ti_int, shape=shape),
        "vface_end": V(dtype=ezsim.ti_int, shape=shape),
        "color": V(dtype=ezsim.ti_vec4, shape=shape),
    }
...
def get_equalities_info(solver):
    ...
    kwargs = {
        "eq_obj1id": V(dtype=ezsim.ti_int, shape=shape),
        "eq_obj2id": V(dtype=ezsim.ti_int, shape=shape),
        "eq_data": V(dtype=ezsim.ti_vec11, shape=shape),
        "eq_type": V(dtype=ezsim.ti_int, shape=shape),
        "sol_params": V(dtype=ezsim.ti_vec7, shape=shape),
    }
...
def get_entities_info(solver):
    ...
    kwargs = {
        ...
        "dof_end": V(dtype=ezsim.ti_int, shape=shape),
        "n_dofs": V(dtype=ezsim.ti_int, shape=shape),
        "link_start": V(dtype=ezsim.ti_int, shape=shape),
        "link_end": V(dtype=ezsim.ti_int, shape=shape),
        "n_links": V(dtype=ezsim.ti_int, shape=shape),
        "geom_start": V(dtype=ezsim.ti_int, shape=shape),
        "geom_end": V(dtype=ezsim.ti_int, shape=shape),
        "n_geoms": V(dtype=ezsim.ti_int, shape=shape),
        "gravity_compensation": V(dtype=ezsim.ti_float, shape=shape),
        "is_local_collision_mask": V(dtype=ezsim.ti_bool, shape=shape),
